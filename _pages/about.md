...
@import url('https://fonts.googleapis.com/css2?family=Caveat:wght@500&family=Zhi+Mang+Xing&family=Ma+Shan+Zheng&display=swap');
...
.photo-note {
  ...
  color: #333;
  line-height: 1.4;
  font-family: 'Caveat', 'Ma Shan Zheng', 'Kaiti SC', 'KaiTi', 'STKaiti', cursive;
}
