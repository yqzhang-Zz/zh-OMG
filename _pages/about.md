...
<div style="display: flex; align-items: flex-end; margin-top: 4px; margin-bottom: 20px;">
  <div style="width: 160px; height: 3px; background-color: #1A365D;"></div>
...
<h1 style="border-bottom: none; margin-bottom: 8px; padding-bottom: 0;">🎯 价值观与目标</h1>
<div style="display: flex; align-items: flex-end; margin-top: 4px; margin-bottom: 20px;">
  <div style="width: 160px; height: 3px; background-color: #1A365D;"></div>
  <div style="flex-grow: 1; height: 1px; background-color: #1A365D;"></div>
</div>
...
<br>
<h1 style="border-bottom: none; margin-bottom: 8px; padding-bottom: 0;">💻 入组考核要求</h1>
<div style="display: flex; align-items: flex-end; margin-top: 4px; margin-bottom: 20px;">
  <div style="width: 160px; height: 3px; background-color: #1A365D;"></div>
  <div style="flex-grow: 1; height: 1px; background-color: #1A365D;"></div>
</div>
...
<br>
<h1 style="border-bottom: none; margin-bottom: 8px; padding-bottom: 0;">🧑‍🎓 成员</h1>
<div style="display: flex; align-items: flex-end; margin-top: 4px; margin-bottom: 20px;">
  <div style="width: 160px; height: 3px; background-color: #1A365D;"></div>
  <div style="flex-grow: 1; height: 1px; background-color: #1A365D;"></div>
</div>
...
- <span class="tag tag-sigllm">SIGLLM</span> (LLM: Large Language Models) 大语言模型特别兴趣小组<br>
并不断调整以追踪和适配前沿学术研究风向。课题组部分成员如下：
...
<div class="student-grid">
  ...
  <div class="student-card">
    ...
    <div class="student-body">
      ...
      <p><strong>研究方向：</strong> 异构特征数据分析与大语言模型</p>
  ...
  <div class="student-card">
    ...
    <div class="student-body">
      ...
      <p><strong>研究方向：</strong> 图表征学习与大语言模型</p>
  ...
  <div class="student-card">
    ...
    <div class="student-body">
      ...
      <p><strong>主要成果：</strong> 获本科生国家奖学金；发表CCF-A/SCI一/二区论文多篇，如AAAI'25，NEUCOM'25；成果获国际会议最佳论文奖和挑战杯国赛三等奖。</p>
    </div>
  </div>
...
<br>
<h1 style="border-bottom: none; margin-bottom: 8px; padding-bottom: 0;">🖼️ 影像</h1>
<div style="display: flex; align-items: flex-end; margin-top: 4px; margin-bottom: 20px;">
  <div style="width: 160px; height: 3px; background-color: #1A365D;"></div>
  <div style="flex-grow: 1; height: 1px; background-color: #1A365D;"></div>
</div>
...
<style>
/* 引入手写字体：英文用 Caveat，中文用 Ma Shan Zheng */
