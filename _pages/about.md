...
- 复杂分布数据聚类特别兴趣小组 <span class="tag tag-sigcdc">SIGCDC</span> (CDC: Complex-distributed Data Clustering)<br>
- 多变量时序数据分析特别兴趣小组 <span class="tag tag-sigmta">SIGMTA</span> (MTA: Multi-variate Time-series Analysis)<br>
- 大语言模型特别兴趣小组 <span class="tag tag-sigllm">SIGLLM</span> (LLM: Large Language Models)<br>
并不断调整以追踪和适配前沿学术研究风向。课题组部分成员展示如下：
